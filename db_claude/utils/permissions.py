"""
Permission system for db-claude.
Architecturally mirrors Claude Code's permission system (src/utils/permissions/).
"""
...
class PermissionMode(str, Enum):
    """Permission modes matching Claude Code's PermissionMode."""
    DEFAULT = "default"
...
class ToolPermissionContext:
    ...
    def check_tool_permission(
        ...
        Mirrors the permission resolution logic in Claude Code.
        """

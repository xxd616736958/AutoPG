"""
Agent state definition for db-claude.
Mirrors the QueryEngine state and query loop state from Claude Code.
"""
...
class ToolUseContext(TypedDict, total=False):
    """Context passed to tool calls, matching Claude Code's ToolUseContext."""
    cwd: str
    tools: list
    verbose: bool
    main_loop_model: str

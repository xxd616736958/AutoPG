"""System prompt sections — matching Claude Code's constants/prompts.ts."""
from ..tools.display import format_call as _fc


def get_doing_tasks_section() -> str:
    """Matching Claude Code's getSimpleDoingTasksSection."""
    return """# Doing Tasks
...
def get_actions_section() -> str:
    """Matching Claude Code's getActionsSection."""
...
def get_using_tools_section() -> str:
    """Matching Claude Code's getUsingYourToolsSection."""
...
def get_tone_section() -> str:
    """Matching Claude Code's getSimpleToneAndStyleSection."""
...
def get_git_safety_section() -> str:
    """Matching Claude Code's git safety protocol in BashTool prompt."""

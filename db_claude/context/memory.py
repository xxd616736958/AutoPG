"""
Memory system for db-claude.
Architecturally identical to Claude Code's memory directory system (src/memdir/).
...
class MemoryManager:
    ...
    Mirrors Claude Code's memdir/memdir.ts and MEMORY.md mechanics.

    Memory files are stored in ~/.db-claude/projects/<project-hash>/memory/

"""
Slash command system for AutoPG.
Architecturally identical to AutoPG's slash commands (src/commands.ts).
"""
...
class SlashCommandHandler:
    ...
    Mirrors AutoPG's command system (src/commands.ts).
    """
    ...
    def _register_defaults(self):
        ...
        self.register(SlashCommand(
            name="exit",
            description="Exit AutoPG",
            handler=self._cmd_exit,
            aliases=["quit", "q"],
        ))
        self.register(SlashCommand(
            name="version",
            description="Show AutoPG version",
    ...
    def _cmd_resume(self, args: list, context: dict) -> str:
        """Open interactive session picker (AutoPG style).

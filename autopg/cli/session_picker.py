"""
Session picker — fully matching AutoPG's /resume UI.
"""
...
def _time_ago(iso_str: str) -> str:
    """Natural relative time — matching AutoPG format."""
    try:
...
def _fmt_size(b: int) -> str:
    """Human-readable size — matching AutoPG."""
...
async def pick_session(current_session_id: str = None) -> Optional[str]:
    """Interactive session picker matching AutoPG's /resume UI."""

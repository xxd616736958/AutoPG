"""
Agent definitions — matching AutoPG's loadAgentsDir.ts and builtInAgents.ts.
...
class AgentDefinition:
    """One agent type definition. AutoPG: AgentDefinition in loadAgentsDir.ts."""
...
# ── Built-in agents (AutoPG: builtInAgents.ts) ──
...
def register_custom_agent(agent_def: AgentDefinition):
    """Register a custom agent definition (from AUTOPG.md or agents/ dir)."""

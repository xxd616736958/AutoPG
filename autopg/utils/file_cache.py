...
AutoPG equivalents: FileStateCache (LRU 100 entries, 25MB), memoize on getGitStatus/getUserContext.
"""
...
# ── File state LRU cache (AutoPG: FileStateCache) ──
...
# ── Context memoization (AutoPG: lodash memoize on getUserContext/getSystemContext) ──
